...
public class ManagerTablet {
    ...
    public void printActiveVideoSet() {
        List<Advertisement> videoSet = StatisticsAdvertisementManager.getInstance().getActiveAds();
    ...
    public void printArchivedVideoSet() {
        List<Advertisement> videoSet = StatisticsAdvertisementManager.getInstance().getInactiveAds();
        Collections.sort(videoSet, new Comparator<Advertisement>() {
            @Override
            public int compare(Advertisement o1, Advertisement o2) {
                return o1.getName().toLowerCase().compareTo(o2.getName().toLowerCase());
